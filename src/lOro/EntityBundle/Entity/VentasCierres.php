...
class VentasCierres
{
   ...
   /**
     ...
     * @var string
     *
     * @ORM\Column(name="descuento_onza_cliente", type="decimal", precision=2, scale=2, nullable=true, options={"default" : 0.95})
     */
    private $descuentoOnzaCliente;

    /**
     * @var string
     *
     * @ORM\Column(name="descuento_onza_proveedor", type="decimal", precision=2, scale=2, nullable=true, options={"default" : 0.97})
     */
    private $descuentoOnzaProveedor;
    ...
    /**
     * Set descuentoOnzaCliente
     *
     * @param string $descuentoOnzaCliente
     *
     * @return VentasCierres
     */
    public function setDescuentoOnzaCliente($descuentoOnzaCliente)
    {
        $this->descuentoOnzaCliente = $descuentoOnzaCliente;

        return $this;
    }

    /**
     * Get descuentoOnzaCliente
     *
     * @return string
     */
    public function getDescuentoOnzaCliente()
    {
        return $this->descuentoOnzaCliente;
    }

    /**
     * Set descuentoOnzaProveedor
     *
     * @param string $descuentoOnzaProveedor
     *
     * @return VentasCierres
     */
    public function setDescuentoOnzaProveedor($descuentoOnzaProveedor)
    {
        $this->descuentoOnzaProveedor = $descuentoOnzaProveedor;

        return $this;
    }

    /**
     * Get descuentoOnzaProveedor
     *
     * @return string
     */
