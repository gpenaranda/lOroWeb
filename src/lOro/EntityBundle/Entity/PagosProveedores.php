 ...
 * PagosProveedores
 *
 * @ORM\Table(name="pagos_proveedores")
 * @ORM\Entity(repositoryClass="lOro\EntityBundle\Entity\Repository\PagosProveedoresRepository")
 */
class PagosProveedores
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\lOro\EntityBundle\Entity\EmpresasProveedores", inversedBy="pagosRealizadosCasa")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\lOro\EntityBundle\Entity\EmpresasProveedores", inversedBy="pagosRealizados")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="\lOro\EntityBundle\Entity\TipoTransaccion", inversedBy="pagosProveedores")
